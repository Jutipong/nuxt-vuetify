    ...
    <VRow justify="center">
      <VDialog v-model="active" persistent width="1024">
        <VCard>
          ...
          <VCardActions>
            <VSpacer />
            <VBtn color="warning" prepend-icon="mdi-close" text="Close" @click="onClose()" />
            <VBtn color="primary" prepend-icon="mdi-content-save" text="Save" :loading="$g.isLoading" @click="onSave()" />
          </VCardActions>
        </VCard>
      </VDialog>
    </VRow>
