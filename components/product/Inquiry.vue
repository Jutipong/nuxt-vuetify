...
<template>
  <v-container>
    ...
    <!-- search -->
    <VCard class="mb-2" @keyup.enter="func.getProducts()">
      <VCardTitle>
      ...
      <VCardText>
        <VRow class="">
          ...
          <VCol cols="12" md="4">
            <VSelect v-model="state.search.status" label="Status" :dirty="true"
    ...
    <VCard>
      ...
      <VDivider />
      <VCardText>
        <VDataTableServer :items-per-page="state.table.options.itemsPerPage" :headers="state.header"
